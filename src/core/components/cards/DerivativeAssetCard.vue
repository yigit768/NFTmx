    ...
    >
      <div class="relative w-full overflow-hidden pt-73per bg-black">
        ...
        <ribbon
          ...
          :percent="asset.currentOrder.protectionRate"
          :period="Math.ceil(asset.currentOrder.protectionTime / 86400)"
        />
      </div>
      <div class="relative px-4.5 pt-5.5 pb-5 bg-tertiary-700">
        ...
        <div class="flex text-white overflow-hidden mt-7.25">
        ...
        <div class="flex gap-2 items-center mt-3">
          <div
            class="border-t border-t-black border-b border-b-tertiary-600 w-full h-0"
          />
          <div class="text-black font-ibm-medium text-11 whitespace-nowrap">
