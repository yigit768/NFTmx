        ...
        >
          ...
          >
            ...
            <router-link
              ...
              class="transition bg-black hover:shadow-[0_0px_12px_0px_rgb(0_0_0_/_0.1),_0_0px_0px_0px_rgb(0_0_0_/_0.1);] hover:shadow-primary-900 text-secondary-900 font-press w-full flex items-center justify-center h-15 bottom-0 absolute text-sm"
            >
              BECOME A BACKER
            </router-link>
          </div>
