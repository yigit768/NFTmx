...
import { useEthers, displayEther, shortenAddress, useWallet } from "vue-dapp";
import {
  getChainKey,
  roundTo,
  getDateAgo,
...
import { addLiquidity } from "@/core/utils/contracts/syndication.utils.js";
...
const joinSyndication = async () => {
  ...
  try {
    ...
    addLiquidity(
      ...
      .then((res) => {
        emit("update-syndication");
        toast.success("You added liquidity successfully");
      })
      .catch((err) => {
        if (err.code === 4001) {
          toast.error("User denied transaction signature.");
  ...
  >
    <div class="bg-tertiary-900 text-white xl:w-modal-md 3xl:w-modal-big">
      ...
      <div class="text-center">
        <div class="font-press text-xl md:text-2xl leading-6 mx-4">
      ...
      <div class="px-4 md:px-16 pb-20 mt-9">
        <div
          ...
          >
            ...
            <tbody class="font-ibm-light text-xs">
              ...
              >
                ...
                <td class="py-4 border-r border-black px-4">
                  {{
                    roundTo((asset.syndication.total / item.investment) * 100)
                  }}%
                </td>
                <td
        ...
        <div class="text-11 font-ibm mt-3.5 text-right text-tertiary-400">
          Balance:
        ...
        <div
          v-if="
            selectedWallet === 'Wallet Balance' && walletBalanceInEth < nftPrice
          "
