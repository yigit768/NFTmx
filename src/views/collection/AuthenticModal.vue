    ...
    <div class="bg-tertiary-900 text-white xl:w-home-lg">
      ...
      <div class="text-white pt-10.5 pb-17.5 px-4 lg:px-17.25">
        <div class="font-ibm-bold text-sm sm:text-lg py-2 sm:leading-6">
          Check if your NFT address and this collection are connected
        </div>
        ...
        <div v-if="!authenticStatus" class="mt-12.5 font-press text-lg">
          <nftmx-button
        ...
        <div
          ...
          class="mt-12.5 h-16.5 bg-black text-red-900 leading-6 flex items-center justify-center gap-5"
        >
