...
import CategoriyModal from "./CategoriyModal.vue";
...
function save() {
  ...
  collection.append("categoryId", category.value.id);
  marketService
...
<template>
  <body-container>
    ...
    <div>
      ...
      <setting-item-row class="mt-10">
        ...
        <template v-slot:value>
          ...
          >
            <nftmx-textarea v-model="description" />
          </div>
        </template>
      </setting-item-row>
      <setting-item-row>
        ...
        <template v-slot:value>
          ...
          >
            <div class="flex gap-4">
              <button
                class="bg-primary-900 font-ibm-medium text-white flex items-center justify-center w-64 h-13.5"
              ...
              >
                ...
                <font-awesome-icon
                  :icon="['fas', 'times']"
                  class="transition cursor-pointer hover:text-red-900"
                  @click="category = {}"
                />
              </div>
            </div>
    ...
    <categoriy-modal v-model="categoryModal" @add-category="addCategory" />
  </body-container>
</template>
