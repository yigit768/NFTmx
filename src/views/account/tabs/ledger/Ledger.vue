...
const tab = ref(
  route.query.tab === "offers-received" ? "Offers Received" : "Trading History"
);
...
<template>
  <div class="relative">
    <div class="xl:absolute w-full pt-7.5 pb-4.25">
      ...
      >
        <div class="flex gap-5 py-2 w-max">
          <list-group-item
            :active="tab === 'Trading History'"
            @click="selectTab('Trading History')"
          >
            Trading History
          </list-group-item>
          <div
    ...
    <trading-history v-if="tab === 'Trading History'" />
