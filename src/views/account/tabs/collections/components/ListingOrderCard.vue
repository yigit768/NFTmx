...
const cancelSaleModal = ref(false);
...
<template>
  <div>
            ...
            >
              ...
              <div class="text-center">
                <span
                  ...
                  class="text-red-800 hover:text-red-900 transition cursor-pointer font-ibm-medium"
                  @click="cancelSale"
                >
                  Delist
                </span>
            ...
            >
              ...
              <div class="flex justify-center">
                <timer
                  :time="
                    parseInt(
                      order.offerClosingTime - new Date().getTime() / 1000 > 0
                        ? order.offerClosingTime - new Date().getTime() / 1000
                        : 0
                    )
                  "
                />
              ...
              <div class="flex justify-between gap-4">
                ...
                >
                  ...
                  >
                    ...
                    <div
                      v-if="
                        order.nft.image512 && accountAddress === walletAddress
                      "
                      @click="makeProfilePicture(order.nft.image512)"
                      class="transition text-white hover:text-primary-900 cursor-pointer"
                    >
    ...
    <nftmx-cancel-modal v-model="cancelSaleModal" @confirm="cancelSale" />
  </div>
</template>
