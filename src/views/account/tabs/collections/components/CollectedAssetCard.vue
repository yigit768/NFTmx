...
import CreateDerivativeModal from "./CreateDerivativeModal.vue";
...
const derivativeCreated = () => {
  emit("remove-asset", props.token);
};
const hideNFT = () => {
...
<template>
  <div>
            ...
            <div class="relative h-23 mb-0.5">
              <div class="flex justify-between gap-4">
                <div>
                  ...
                  <nftmx-trim-string
                    :line="2"
                    class="text-white font-ibm-medium text-sm leading-5.25"
                  >
                ...
                >
                  ...
                  >
                    <div
                      v-if="
                        accountAddress === walletAddress && !token.mlrContract
                      "
                      class="transition text-primary-900 hover:text-primary-700 cursor-pointer border-b border-tertiary-900 pb-2.25 mb-2"
                      @click="
                        () => {
                          derivativeAsset = token;
                          openDerivativeModal = true;
                        }
                      "
                    >
                      Create derivatives
                    ...
                    <div
                      v-if="accountAddress === walletAddress"
                    ...
                    <div
                      v-if="accountAddress === walletAddress && token.image512"
                      @click="makeProfilePicture(token.image512)"
                      class="transition text-white hover:text-primary-900 cursor-pointer"
                    >
    ...
    <create-derivative-modal
      ...
      @derivative-created="derivativeCreated"
    />
  </div>
</template>
