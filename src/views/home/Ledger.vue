    ...
    <div
      ...
      :class="[
        tab === 'COLLECTIONS'
          ...
          ? 'lg:pb-11.25'
          : '',
        'w-full lg:w-68 lg:pt-2 cursor-default transition-all overflow-hidden h-full flex flex-col',
      ]"
      :style="{
        maxWidth:
    ...
    >
      <div class="flex justify-between items-center text-white">
        ...
        <div
          ...
          class="font-ibm border-t-2 lg:border-t-0 lg:border-l-2 border-white transition hover:border-primary-900 text-white hover:text-primary-900 h-5 w-5 flex items-center justify-center pt-1 lg:pt-0 lg:pl-1 cursor-pointer"
        >
          <font-awesome-icon
            :icon="[
              'fas',
              windowWidth >= themeConfig.lg ? 'arrow-left' : 'arrow-up',
            ]"
          />
        </div>
      </div>
      <div class="mt-5.5 w-full lg:w-68 h-full flex flex-col">
        <div
    ...
    <div class="h-5">
      <div
        ...
        :class="[
          ...
          'absolute right-0 lg:right-auto lg:top-3.5 lg:-left-10 font-ibm border-t-2 lg:border-t-0 lg:border-l-2 border-white transition hover:border-primary-900 text-white hover:text-primary-900 h-5 w-5 flex items-center justify-center pt-1 lg:pt-0 lg:pl-1 cursor-pointer',
        ]"
      >
        <font-awesome-icon
          :icon="[
            'fas',
            windowWidth >= themeConfig.lg ? 'arrow-right' : 'arrow-down',
          ]"
        />
      </div>
    </div>
