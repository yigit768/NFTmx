      ...
      >
          ...
          <div class="border border-black px-5 mt-4.75 py-3.5">
            ...
            <div class="mt-4">
              <div class="flex items-center gap-2">
                <nftmx-radio
                  size="sm"
                  :active="fundStruct === 'OPEN'"
                  @click="fundStruct = 'OPEN'"
                />
                <span>
                  Open ended fund
                  <nftmx-tooltip text="open ended fund">
                    <font-awesome-icon
        ...
        <div>
          <div class="border border-black px-5 py-4 h-42.5">
            <div class="">
              <div class="flex items-center gap-2">
                <nftmx-radio
                  size="sm"
                  :active="feeStruct === 'CARRY'"
                  @click="feeStruct = 'CARRY'"
                />
                <span class="text-sm"> Carry % </span>
              </div>
              <div class="flex items-center gap-2 mt-2.5 mb-4">
                <nftmx-radio
                  size="sm"
                  :active="feeStruct === 'FEE'"
                  @click="feeStruct = 'FEE'"
                />
          ...
          <div class="border border-black px-5 mt-4.75 py-3.5">
            ...
            <div class="mt-4">
              <div class="flex items-center gap-2">
                <nftmx-radio size="sm" :active="kyc" @click="kyc = true" />
                <span> Yes </span>
              </div>
              <div class="flex items-center gap-2 mt-2 mb-4">
                <nftmx-radio size="sm" :active="!kyc" @click="kyc = false" />
                <span> No </span>
              </div>
            </div>
          </div>
