export const colorsBg = {
  primary:
    "bg-gradient-to-r from-primary-600 to-primary-500 text-white transition hover:shadow-[0_0px_12px_0px_rgb(0_0_0_/_0.1),_0_0px_0px_0px_rgb(0_0_0_/_0.1);] hover:shadow-primary-900",
